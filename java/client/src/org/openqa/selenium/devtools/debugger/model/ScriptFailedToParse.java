...
public class ScriptFailedToParse {
    ...
    public ScriptFailedToParse(org.openqa.selenium.devtools.runtime.model.ScriptId scriptId, java.lang.String url, java.lang.Integer startLine, java.lang.Integer startColumn, java.lang.Integer endLine, java.lang.Integer endColumn, org.openqa.selenium.devtools.runtime.model.ExecutionContextId executionContextId, java.lang.String hash, java.util.Map<String, Object> executionContextAuxData, java.lang.String sourceMapURL, java.lang.Boolean hasSourceURL, java.lang.Boolean isModule, java.lang.Integer length, org.openqa.selenium.devtools.runtime.model.StackTrace stackTrace) {
    ...
    private static ScriptFailedToParse fromJson(JsonInput input) {
        ...
        input.endObject();
        return new ScriptFailedToParse(scriptId, url, startLine, startColumn, endLine, endColumn, executionContextId, hash, executionContextAuxData, sourceMapURL, hasSourceURL, isModule, length, stackTrace);
    }
}
